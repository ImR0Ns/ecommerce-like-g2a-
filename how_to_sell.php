...
<body>
    <div class="container posR">
        ...
        <img src="./img/img_how_to__buy/howToSell.png" alt="" class="wirtingF">

        <p class="nowIsTime">Now is the right time to make money</p>
        <p class="subTitleTime">Let's sell right now</p>
        <button class="sellNowButtS">Sell now</button>
